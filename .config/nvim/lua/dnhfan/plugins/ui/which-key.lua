    ...
    spec = {
      {
        ...
        { "<leader>fr", group = "flutter run", icon = { icon = " " } },
        { "<leader>fp", group = "flutter pub", icon = { icon = " " } },
        { "<leader>ft", desc = "Flutter Test", icon = { icon = " " } },
        { "<leader>fT", desc = "Flutter Test Run", icon = { icon = " " } },
        { "<leader>g", group = "git" },
        ...
        { "<leader>E", group = "cwd file explorer", icon = "󰙅 " },
...

        {
          ...
          { "<leader><tab>q", "<cmd>tabclose<cr>", desc = "Close Tab", icon = "󰅖 " },
